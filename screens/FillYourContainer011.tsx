...
const FillYourContainer011 = () => {
  ...
  return (
    <View style={styles.fillYourContainer01}>
      ...
      <Pressable
        style={styles.step2Pressable}
        onPress={() => navigation.navigate("FillYourContainer01")}
      >
        <Image
      ...
      <Image
        style={styles.x1Icon}
        resizeMode="cover"
        source={require("../assets/012x-1.png")}
      />
      <Text style={styles.placeYourContainerUnderThe}>
        <Text style={styles.placeYourContainer}>
          <Text style={styles.placeYour}>{`Place your `}</Text>
          <Text style={styles.containerText1}>Container</Text>
        </Text>
        <Text style={styles.underTheSpout1}>
          <Text style={styles.underTheSpout}> Under the Spout</Text>
        </Text>
      </Text>
      <Pressable
...
export default FillYourContainer011;
