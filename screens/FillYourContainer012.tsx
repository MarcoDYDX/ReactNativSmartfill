  ...
  return (
    <View style={styles.fillYourContainer01}>
      ...
      <Text style={styles.pressStopWhenYouHaveEnoug}>
        <Text style={styles.pressStopWhen}>
          <Text style={styles.pressText}>{`Press `}</Text>
          <Text style={styles.stopText}>Stop</Text>
          <Text style={styles.whenText}>{` when `}</Text>
        </Text>
        <Text style={styles.youHaveEnough1}>
          <Text style={styles.youHaveEnough}>you have enough.</Text>
        </Text>
      </Text>
      <Pressable
      ...
      <Image
        style={styles.x3Icon}
        resizeMode="cover"
        source={require("../assets/032x-3.png")}
      />
      <Pressable
...
export default FillYourContainer012;
