...
const NutritionalInformation = () => {
  ...
  return (
    <View style={styles.nutritionalInformationView}>
      <Image
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/product-price.png")}
      />
      ...
      <Text style={styles.caloriesProteinTotalFat}>
        ...
        <Text style={styles.totalFatText}>Total fat: </Text>
        <Text style={styles.blankLineText2}> </Text>
        <Text style={styles.sodiumText}>Sodium:</Text>
        <Text style={styles.blankLineText3}> </Text>
        <Text style={styles.potassiumText}>Potassium:</Text>
      </Text>
      <Text style={styles.g1g1g6mg362mg}>
        <Text style={styles.gText}>120g</Text>
        <Text style={styles.blankLineText4}> </Text>
        <Text style={styles.gText1}>1g</Text>
        <Text style={styles.blankLineText5}> </Text>
        <Text style={styles.gText2}>1g</Text>
        <Text style={styles.blankLineText6}> </Text>
        <Text style={styles.mgText}>6mg</Text>
        <Text style={styles.blankLineText7}> </Text>
        <Text style={styles.mgText1}>362mg</Text>
      </Text>
      <Text style={styles.nutritionalInformationText}>
